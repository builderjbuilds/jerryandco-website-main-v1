...
// manifest per the image spec doc. Regenerated a second time on 2026-08-31:
// card-elevated-deck (cleaner take on the same prompt), card-hardscape-patio
// and carousel-hardscape (cleaner takes), and section-service-area (v1 and
// v2 both rendered as a seamed 3-panel collage instead of one photograph —
// v3 fixed it with an explicit "single unified image, not a collage" prompt).
const IMAGES = {
  // P0
  ...
  // P1
  'nj-design-build/card-hardscape-patio': 'hf_20260831_194647_4b3ce94a-4a3d-4c5f-a821-888120db0856.png',
  ...
  'nj-design-build/section-service-area': 'hf_20260831_213503_2488ca93-f9c2-4679-8f83-401e0b48bd51.png',
  ...
  'nj-design-build/carousel-hardscape': 'hf_20260831_194732_4bcfe145-0be5-4fb3-a06f-a7a140293481.png',
